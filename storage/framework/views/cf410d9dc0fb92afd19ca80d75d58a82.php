            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 15px;">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $smslist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        ...
                        <p style="margin: 10px 0;">تعداد پیام: <?php echo e($item->count); ?></p>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/meseger/resources/views/dashbord.blade.php ENDPATH**/ ?>