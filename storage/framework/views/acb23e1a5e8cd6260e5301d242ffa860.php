            ...
            <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div
                    ...
                    <a href="<?php echo e(route('admin.userdashboard', $item->id)); ?>" class="my-link">
                        ...
                        <strong>نام خانوادگی: <?php echo e($item->lname); ?></strong><br><br>

                        <strong>مجموع هزینه پیام ها: <?php echo e(($sms_count[$item->id]?? 0 )*$cost); ?> ریال</strong><br>
                        <strong>تعداد پیام ها: <?php echo e($sms_count[$item->id]?? 0); ?> </strong>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /opt/meseger/resources/views/admin.blade.php ENDPATH**/ ?>