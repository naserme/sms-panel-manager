...
<?php $__env->startSection('content'); ?>
    ...
    <div style="flex: 3 1 500px; background:#fff; border-radius: 10px; padding: 20px; box-shadow:0 0 10px rgba(0,0,0,0.1);">
        <div style="margin-top: 20px;">
            <h4>جمع هزینه‌ها:</h4>
            <p>
                <?php echo e($smslist->sum('cost')); ?> ریال
            </p>
        </div>
...
<?php echo $__env->make('layouts.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\software\Installed\laragon\www\endpoint\resources\views/userprofile.blade.php ENDPATH**/ ?>